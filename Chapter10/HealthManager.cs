...
public class HealthManager : MonoBehaviour
{
    ...
    [SerializeField, Tooltip("Frames of damage immunity after being hit.")]
    private float _invincibilityFramesMax = 0;

    [SerializeField, Tooltip("Remaining frames of immunity after being hit.")]
